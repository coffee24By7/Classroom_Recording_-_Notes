...
app.config(function ($stateProvider) {
  ...
  $stateProvider
    ...
    views: {
        "viewA": { template: "<p>Hello you from view a</p>" },
        "viewB": { template: "<p>Hello you from view b</p>" }
      }
    })
    .state('app', {
      abstract: true,
    ...
    .state('app.dashboard', {
     url: '/app',
    views: {
            "viewA": { template: "<p>You already logged in. Hello you from view a</p>" },
            "viewB": { template: "<p>You already logged in. Hello you from view b</p>" }
      }
      // child state of `app`
      // requireLogin === true
    })
